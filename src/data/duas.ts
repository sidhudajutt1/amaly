...
export const duas: DuaData[] = [
...

  {
    ...
    categoryId: 'morning',
    textAr:
      'أَصْبَحْنَا وَأَصْبَحَ الْمُلْكُ لِلَّهِ، وَالْحَمْدُ لِلَّهِ، لَا إِلَـٰهَ إِلَّا اللهُ وَحْدَهُ لَا شَرِيكَ لَهُ، لَهُ الْمُلْكُ وَلَهُ الْحَمْدُ وَهُوَ عَلَىٰ كُلِّ شَيْءٍ قَدِيرٌ. رَبِّ أَسْأَلُكَ خَيْرَ مَا فِي هَـٰذَا الْيَوْمِ وَخَيْرَ مَا بَعْدَهُ، وَأَعُوذُ بِكَ مِنْ شَرِّ مَا فِي هَـٰذَا الْيَوْمِ وَشَرِّ مَا بَعْدَهُ، رَبِّ أَعُوذُ بِكَ مِنَ الْكَسَلِ وَسُوءِ الْكِبَرِ، رَبِّ أَعُوذُ بِكَ مِنْ عَذَابٍ فِي النَّارِ وَعَذَابٍ فِي الْقَبْرِ',
    translationEn:
      'We have reached the morning and at this very time all sovereignty belongs to Allah. All praise is for Allah. None has the right to be worshipped except Allah, alone, without partner. To Him belongs all sovereignty and praise, and He is over all things omnipotent. My Lord, I ask You for the good of this day and the good of what follows it, and I seek refuge in You from the evil of this day and the evil of what follows it. My Lord, I seek refuge in You from laziness and senility. My Lord, I seek refuge in You from torment in the Hellfire and punishment in the grave.',
    translationUr:
      'ہم نے صبح کی اور اللہ کی بادشاہی نے صبح کی، اور تمام تعریفیں اللہ کے لیے ہیں۔ اللہ کے سوا کوئی معبود نہیں، وہ اکیلا ہے اس کا کوئی شریک نہیں، اسی کی بادشاہی ہے اور اسی کے لیے تعریف ہے اور وہ ہر چیز پر قادر ہے۔ اے میرے رب! میں تجھ سے اس دن کی بھلائی اور اس کے بعد کی بھلائی مانگتا ہوں، اور اس دن کے شر اور اس کے بعد کے شر سے تیری پناہ چاہتا ہوں۔ اے میرے رب! میں سستی اور بڑھاپے کی برائی سے تیری پناہ چاہتا ہوں۔ اے میرے رب! میں جہنم کے عذاب اور قبر کے عذاب سے تیری پناہ مانگتا ہوں۔',
    transliteration:
      "Asbahnaa wa asbahal-mulku lillaah, walhamdu lillaah, laa ilaaha illallaahu wahdahu laa shareeka lah, lahul-mulku wa lahul-hamdu wa huwa 'alaa kulli shay'in qadeer. Rabbi as'aluka khayra maa fee haathal-yawmi wa khayra maa ba'dah, wa a'oothu bika min sharri maa fee haathal-yawmi wa sharri maa ba'dah. Rabbi a'oothu bika minal-kasali wa soo'il-kibar. Rabbi a'oothu bika min 'athaabin fin-naari wa 'athaabin fil-qabr.",
  ...
  },
  {
    ...
    translationUr:
      'اے اللہ! تیری مدد سے ہم نے صبح کی اور تیری مدد سے ہم نے شام کی، تیری مدد سے ہم جیتے ہیں اور تیری مدد سے ہم مرتے ہیں، اور تیری طرف اٹھ کر جانا ہے۔',
    transliteration:
  ...
  },
  {
    ...
    categoryId: 'morning',
    textAr:
      'اللَّهُمَّ أَنْتَ رَبِّي لَا إِلَـٰهَ إِلَّا أَنْتَ، خَلَقْتَنِي وَأَنَا عَبْدُكَ، وَأَنَا عَلَىٰ عَهْدِكَ وَوَعْدِكَ مَا اسْتَطَعْتُ، أَعُوذُ بِكَ مِنْ شَرِّ مَا صَنَعْتُ، أَبُوءُ لَكَ بِنِعْمَتِكَ عَلَيَّ، وَأَبُوءُ لَكَ بِذَنْبِي فَاغْفِرْ لِي فَإِنَّهُ لَا يَغْفِرُ الذُّنُوبَ إِلَّا أَنْتَ',
    translationEn:
    ...
    translationUr:
      'اے اللہ! تو میرا رب ہے، تیرے سوا کوئی معبود نہیں۔ تو نے مجھے پیدا کیا اور میں تیرا بندہ ہوں، اور میں اپنی طاقت کے مطابق تیرے عہد اور وعدے پر قائم ہوں۔ میں نے جو کچھ کیا اس کے شر سے تیری پناہ چاہتا ہوں۔ میں تیری نعمت کا اقرار کرتا ہوں جو تو نے مجھ پر کی، اور اپنے گناہ کا بھی اقرار کرتا ہوں، پس مجھے معاف فرما دے کیونکہ تیرے سوا کوئی گناہوں کو معاف نہیں کر سکتا۔',
    transliteration:
      "Allaahumma anta rabbee laa ilaaha illaa ant, khalaqtanee wa ana 'abduk, wa ana 'alaa 'ahdika wa wa'dika mastata't, a'oothu bika min sharri maa sana't, aboo'u laka bini'matika 'alayy, wa aboo'u laka bithanbee faghfir lee fa innahu laa yaghfiruth-thunooba illaa ant.",
  ...
  },
  {
    ...
    translationEn:
      'O Allah, what blessing I or any of Your creation have risen upon, is from You alone, without partner. So for You is all praise and for You is all thanks.',
    translationUr:
      'اے اللہ! مجھے یا تیری کسی مخلوق کو جو بھی نعمت ملی ہے وہ صرف تیری طرف سے ہے، تو اکیلا ہے تیرا کوئی شریک نہیں، پس تمام تعریفیں تیرے لیے ہیں اور تمام شکر تیرے لیے ہے۔',
    transliteration:
  ...
  },
  {
    ...
    translationEn:
      'Glory is to Allah and praise is to Him. Whoever says this one hundred times in the morning and evening, no one will come on the Day of Resurrection with anything better than what he has done, except one who has said the same or more.',
    translationUr:
      'اللہ پاک ہے اور اس کی حمد کے ساتھ۔ جو شخص صبح و شام سو مرتبہ یہ کہے، قیامت کے دن کوئی اس سے بہتر عمل لے کر نہیں آئے گا سوائے اس کے جس نے اتنا ہی یا اس سے زیادہ کہا ہو۔',
    transliteration: 'SubhaanAllaahi wa bihamdih.',
    source: 'Muslim 4/2071 · Hisnul Muslim 92',
    repetitions: 100,
  },
...

  {
    ...
    categoryId: 'evening',
    textAr:
      'أَمْسَيْنَا وَأَمْسَى الْمُلْكُ لِلَّهِ، وَالْحَمْدُ لِلَّهِ، لَا إِلَـٰهَ إِلَّا اللهُ وَحْدَهُ لَا شَرِيكَ لَهُ، لَهُ الْمُلْكُ وَلَهُ الْحَمْدُ وَهُوَ عَلَىٰ كُلِّ شَيْءٍ قَدِيرٌ. رَبِّ أَسْأَلُكَ خَيْرَ مَا فِي هَـٰذِهِ اللَّيْلَةِ وَخَيْرَ مَا بَعْدَهَا، وَأَعُوذُ بِكَ مِنْ شَرِّ مَا فِي هَـٰذِهِ اللَّيْلَةِ وَشَرِّ مَا بَعْدَهَا، رَبِّ أَعُوذُ بِكَ مِنَ الْكَسَلِ وَسُوءِ الْكِبَرِ، رَبِّ أَعُوذُ بِكَ مِنْ عَذَابٍ فِي النَّارِ وَعَذَابٍ فِي الْقَبْرِ',
    translationEn:
    ...
    translationUr:
      'ہم نے شام کی اور اللہ کی بادشاہی نے شام کی، اور تمام تعریفیں اللہ کے لیے ہیں۔ اللہ کے سوا کوئی معبود نہیں، وہ اکیلا ہے اس کا کوئی شریک نہیں، اسی کی بادشاہی ہے اور اسی کے لیے تعریف ہے اور وہ ہر چیز پر قادر ہے۔ اے میرے رب! میں تجھ سے اس رات کی بھلائی اور اس کے بعد کی بھلائی مانگتا ہوں، اور اس رات کے شر اور اس کے بعد کے شر سے تیری پناہ چاہتا ہوں۔ اے میرے رب! میں سستی اور بڑھاپے کی برائی سے تیری پناہ چاہتا ہوں۔ اے میرے رب! میں جہنم کے عذاب اور قبر کے عذاب سے تیری پناہ مانگتا ہوں۔',
    transliteration:
      "Amsaynaa wa amsal-mulku lillaah, walhamdu lillaah, laa ilaaha illallaahu wahdahu laa shareeka lah, lahul-mulku wa lahul-hamdu wa huwa 'alaa kulli shay'in qadeer. Rabbi as'aluka khayra maa fee haathihil-laylati wa khayra maa ba'dahaa, wa a'oothu bika min sharri maa fee haathihil-laylati wa sharri maa ba'dahaa. Rabbi a'oothu bika minal-kasali wa soo'il-kibar. Rabbi a'oothu bika min 'athaabin fin-naari wa 'athaabin fil-qabr.",
    source: 'Muslim 4/2088 · Hisnul Muslim 75',
    repetitions: 1,
  },
  {
    ...
    translationUr:
      'اے اللہ! تیری مدد سے ہم نے شام کی اور تیری مدد سے ہم نے صبح کی، تیری مدد سے ہم جیتے ہیں اور تیری مدد سے ہم مرتے ہیں، اور تیری طرف لوٹ کر جانا ہے۔',
    transliteration:
  ...
  },
  {
    ...
    translationUr:
      'میں اللہ کے مکمل کلمات کی پناہ لیتا ہوں اس کی مخلوقات کے شر سے۔',
    transliteration:
      "A'oothu bikalimaatillaahit-taammaati min sharri maa khalaq.",
  ...
  },
  {
    ...
    translationEn:
      'O Allah, what blessing I or any of Your creation have come upon this evening, is from You alone, without partner. So for You is all praise and for You is all thanks.',
    translationUr:
      'اے اللہ! مجھے یا تیری کسی مخلوق کو شام تک جو بھی نعمت ملی ہے وہ صرف تیری طرف سے ہے، تو اکیلا ہے تیرا کوئی شریک نہیں، پس تمام تعریفیں تیرے لیے ہیں اور تمام شکر تیرے لیے ہے۔',
    transliteration:
  ...
  },
  {
    ...
    translationUr:
      'اللہ کے نام سے جس کے نام کے ساتھ زمین و آسمان میں کوئی چیز نقصان نہیں پہنچا سکتی، اور وہ خوب سننے والا جاننے والا ہے۔',
    transliteration:
      "Bismillaahil-lathee laa yadurru ma'asmihi shay'un fil-ardi wa laa fis-samaa'i wa huwas-samee'ul-'aleem.",
    source: 'Abu Dawud 4/323, At-Tirmidhi 5/465 · Hisnul Muslim 84',
    repetitions: 3,
  },
...

  {
    ...
    translationUr: 'اے اللہ! تیرے نام سے مرتا ہوں اور جیتا ہوں۔',
  ...
  },
  {
    ...
    translationEn:
      'In Your Name, my Lord, I lie down and in Your Name I rise. If You take my soul, then have mercy on it, and if You release it, then protect it as You protect Your righteous servants.',
    translationUr:
      'اے میرے رب! تیرے نام سے میں نے اپنا پہلو رکھا اور تیرے نام سے اٹھاؤں گا۔ اگر تو نے میری جان روک لی تو اس پر رحم فرما، اور اگر چھوڑ دی تو اسے اسی طرح محفوظ رکھ جیسے تو اپنے نیک بندوں کو محفوظ رکھتا ہے۔',
    transliteration:
      "Bismika rabbee wada'tu janbee, wa bika arfa'uh, fa in amsakta nafsee farhamhaa, wa in arsaltahaa fahfadhaa, bimaa tahfadhu bihi 'ibaadikas-saaliheen.",
  ...
  },
  {
    ...
    translationUr:
      'اے اللہ! تو نے میری جان پیدا کی اور تو ہی اسے وفات دے گا۔ اس کا مرنا اور جینا تیرے ہاتھ میں ہے۔ اگر تو اسے زندہ رکھے تو اسے محفوظ رکھ، اور اگر تو اسے موت دے تو اسے بخش دے۔ اے اللہ! میں تجھ سے عافیت مانگتا ہوں۔',
    transliteration:
  ...
  {
    id: 'istikharah-01',
    categoryId: 'istikharah',
    textAr:
      'اللَّهُمَّ إِنِّي أَسْتَخِيرُكَ بِعِلْمِكَ، وَأَسْتَقْدِرُكَ بِقُدْرَتِكَ، وَأَسْأَلُكَ مِنْ فَضْلِكَ الْعَظِيمِ، فَإِنَّكَ تَقْدِرُ وَلَا أَقْدِرُ، وَتَعْلَمُ وَلَا أَعْلَمُ، وَأَنْتَ عَلَّامُ الْغُيُوبِ. اللَّهُمَّ إِنْ كُنْتَ تَعْلَمُ أَنَّ هَـٰذَا الْأَمْرَ خَيْرٌ لِي فِي دِينِي وَمَعَاشِي وَعَاقِبَةِ أَمْرِي فَاقْدُرْهُ لِي وَيَسِّرْهُ لِي ثُمَّ بَارِكْ لِي فِيهِ، وَإِنْ كُنْتَ تَعْلَمُ أَنَّ هَـٰذَا الْأَمْرَ شَرٌّ لِي فِي دِينِي وَمَعَاشِي وَعَاقِبَةِ أَمْرِي فَاصْرِفْهُ عَنِّي وَاصْرِفْنِي عَنْهُ وَاقْدُرْ لِيَ الْخَيْرَ حَيْثُ كَانَ ثُمَّ أَرْضِنِي بِهِ',
    translationEn:
    ...
    translationUr:
      'اے اللہ! میں تیرے علم کے ذریعے تجھ سے خیر طلب کرتا ہوں، اور تیری قدرت کے ذریعے تجھ سے طاقت مانگتا ہوں، اور تیرے عظیم فضل سے سوال کرتا ہوں۔ تو قدرت رکھتا ہے اور میں قدرت نہیں رکھتا، تو جانتا ہے اور میں نہیں جانتا، اور تو غیبوں کا جاننے والا ہے۔ اے اللہ! اگر تیرے علم میں یہ کام میرے دین، میری معیشت اور میرے انجام کے لیے بہتر ہے تو اسے میرے لیے مقدر فرما، میرے لیے آسان کر دے، پھر اس میں میرے لیے برکت عطا فرما۔ اور اگر تیرے علم میں یہ کام میرے دین، میری معیشت اور میرے انجام کے لیے برا ہے تو اسے مجھ سے پھیر دے اور مجھے اس سے پھیر دے، اور میرے لیے بھلائی مقدر فرما جہاں بھی ہو، پھر مجھے اس سے راضی فرما۔',
    transliteration:
